...
LIMITED_LABELS = [
  "miscellaneous", "duck", "gosling", "hare", "egyptian_goose", "coot", "swan", 
  "crow", "pidgeon", "magpie", "cat", "oystercatcher", "starling", "jackdaw", 
  "greylag_goose", "canadian_goose", "moorhen", "heron", "pheasant"
]
ALL_LABELS = [
